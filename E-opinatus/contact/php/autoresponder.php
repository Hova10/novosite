                                            ...
                                            <table align="center">
                                               ...
                                               <td style="color:#666;padding:15px; padding-bottom:0;font-size:14px;line-height:20px;font-family:arial;text-align:left">
                                                    ...
                                                    <div style="font-style:normal;padding-bottom:15px;font-family:arial;line-height:20px;text-align:left">
														...
														We have received your message, we will get back to you as soon as possible. </p>
														...
														<p><span style="font-weight:bold;font-size:16px">Your Name:</span> '.$sendername.'</p>
                                                        <p><span style="font-weight:bold;font-size:16px">Your Email:</span> '.$senderemail.'</p>
                                                        <p><span style="font-weight:bold;font-size:16px">Subject:</span> '.$sendersubject.'</p>
                                                        <p><span style="font-weight:bold;font-size:16px;">Your message :</span> </p>
